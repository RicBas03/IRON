"""Streamlit page for logging workouts and viewing workout history."""
...
# collect workout data before submitting it to the database
with st.form("workout_form"):
    ...
    # only show additional fields for endurance sports
...
# process the submitted workout data and save it to the database
if submitted:
    try:
        workout = log_workout(
